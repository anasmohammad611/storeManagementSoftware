...
class Database:
    ...
    def search(self, *args, **kwargs):
        ...
        self.btn_add = Button(self.master, text="Update Database", width=25, height=2, bg='steelblue', fg='white', command=self.update)
        self.btn_add.place(x=520, y=520)

        self.btn_clear = Button(self.master, text="Clear All Fields", width=18, height=2, bg='lightgreen', fg='white',command=self.clear_all)
    ...
    def clear_all(self, *args, **kwargs):
        ...
        sql2 = "INSERT INTO Updated_info (Product_name, stock, date) VALUES (?, ?, ?)"
        c.execute(sql2, (self.namee,self.sstock, date))
        conn.commit()
